...
def main():
    ...
    model = YOLO(r"C:\Users\johan\OneDrive\Escritorio\Universidad\Proyectos Intersemestrales\Captura_automatica_de_posiciones_con_AI_Vision\runs\detect\train5\weights\best.pt")
    ...
    while True:
        ...
        if ids is not None and len(ids) == 4:
            ...
            if all(k in detected for k in [0, 1, 2, 3]):
                ...
                # a8: ID=2 → top-left, h8: ID=3 → top-right,
                # h1: ID=1 → bottom-right, a1: ID=0 → bottom-left
